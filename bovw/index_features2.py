...
### Code based on Guruspyimagesearch BoVW tutorial (Adrian Rosebrock, 2017)
...
################################################################################
# USAGE:
#python index_features2.py --dataset "path/to/your/images" --features-db "path/tofolder/tostore/features" 
#--approx-images "approximate number of images (this should be an integer w/o quotes)" --threshold "hessian threshold for key point detection (integer)"
...
# Detection of keypoints and extraction of features: Initialization (Notice the detector is SURF/FAST Hessian)
if imutils.is_cv2():
...
# Descriptor is RootSIFT, feel free to  change
